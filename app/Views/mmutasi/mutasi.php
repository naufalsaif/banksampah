            ...
            <div class="col-md-10">
                <div class="card">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-6 col-md-8">
                                <form action="<?= base_url('mmutasi/mutasi/' . $uriCurrent); ?>" method="post">
                            ...
                            <div class="col">
                                <a href="<?= base_url('mmutasi/mutasi/' . $uriCurrent); ?>"
                                    class="btn btn-primary mb-3"><i class="fas fa-fw fa-sync-alt"></i></a>
                            </div>
                        </div>
                        <!-- table striped -->
                    ...
                    <div class="d-flex justify-content-center">
                        <?= $pager->links('mutasi', 'bank_pagination'); ?>
                    </div>
                </div>
            </div>
        </div>
