...
<div class="page-content">
    <section class="section">
        <div class="card">
                ...
                <div class="row">
                    <div class="col-lg-8 col-md-6">
                        <button type="button" class="btn btn-outline-primary mb-3" data-bs-toggle="modal"
                            data-bs-target="#scanqr" onclick="addClassValue();"><i class="fa-solid fa-qrcode"></i> Scan
                            QR</button>
                        <a href="<?= base_url('pencairan'); ?>" class="btn btn-primary mb-3"><i
                                class="fas fa-fw fa-sync-alt"></i></a>
                    </div>
                    <div class="col">
                        <form action="<?= base_url('pencairan'); ?>" method="post">
                    ...
                    <table class="table table-striped table-hover table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><a href="<?= base_url('pencairan/dompet/' . $d['id_user']); ?>"
                                        class="btn btn-success"><i class="fa-solid fa-wallet"></i></a></td>
                            </tr>
                            <?php endforeach; ?>
                        </tbody>
                    </table>
            ...
            <?= $pager->links('pencairan', 'bank_pagination'); ?>
        </div>
...
<div class="modal fade text-left" id="scanqr" tabindex="-1" role="dialog" data-bs-backdrop="static"
    data-bs-keyboard="false" aria-labelledby="myModalLabel160" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable" role="document">
        <div class="modal-content">
            ...
            <form action="<?= base_url('pencairan/dompet_redirect'); ?>" method="POST">
                <div class="modal-body">
                    <?= csrf_field(); ?>
                    <div class="modal-body">
                        <video id="scan-qrcode" class="mb-1" width="100%" height="auto"
                            style="border: 1px solid black;"></video>
                        <button type="button" onclick="addClassValue()" id="buttonValue"
                            class="invalid btn btn-primary"><i class="fa-solid fa-arrows-rotate"></i></button>
...
scanner.addListener('scan', function(content) {
    ...
    if (!tombolNext) {
        $('#munculTombol').append(
            '<button type="button" class="btn btn-light-secondary" data-bs-dismiss="modal" onclick="stopCamera()"><span>Cancel</span></button>'
        );
        $('#munculTombol').append(
            '<button type="submit" class="btn btn-primary ml-1" id="tombolNext" onclick="stopCamera()"><span>Next</span></button>'
        );
    }
});
