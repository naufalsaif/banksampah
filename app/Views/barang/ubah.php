                    ...
                    <div class="card-content">
                        <div class="card-body">
                            <form class="form form-vertical"
                                action="<?= base_url('barang/perbarui/' . $dataBarang['id_barang']); ?>" method="post">
                                <div class="form-body">
                                    <div class="row">
                                        <?= csrf_field(); ?>
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="id_barang"
                                                    ...
                                                    name="id_barang"
                                                    value="<?= (old('id_barang') ? old('id_barang') : $dataBarang['id_barang']); ?>"
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="nama_barang"
                                                    ...
                                                    name="nama_barang"
                                                    value="<?= (old('nama_barang') ? old('nama_barang') : $dataBarang['nama_barang']); ?>"
                                        ...
                                        <div class="col-12">
                                            <div class="form-group">
                                                ...
                                                <input type="number" id="harga"
                                                    ...
                                                    name="harga"
                                                    value="<?= (old('harga') ? old('harga') : $dataBarang['harga']); ?>"
